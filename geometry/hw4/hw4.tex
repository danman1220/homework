...
\begin{proof}
    ...
    inclusion map is an injective smooth immersion which is proper, then $S$ is
    embedded.

    Suppose $S$ is compact. Then, by Proposition 4.22, we know that $S$ is
    embedded, since the inclusion map is an injective smooth immersion.
\end{proof}
